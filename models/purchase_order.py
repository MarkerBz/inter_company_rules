...
class purchase_order(models.Model):
    ...
    def inter_company_create_sale_order(self, company):
        ...
        # check pricelist currency
        company_partner_pricelist_currency = company_partner.property_product_pricelist and company_partner.property_product_pricelist.currency_id.id or False
        if company_partner_pricelist_currency != company_partner.property_purchase_currency_id.id:
            raise Warning(_("You cannot create SO from PO because 'company partner pricelist currency' is different than 'company partner purchase currency'."))
