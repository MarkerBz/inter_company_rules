...
class sale_order(models.Model):
    ...
    def inter_company_create_purchase_order(self, company):
        ...
        if self.pricelist_id.currency_id.id != company_partner.property_purchase_currency_id.id:
    ...
    def _prepare_purchase_order_data(self, company, company_partner):
        ...
        return {
            ...
            'fiscal_position_id': company_partner.property_account_position_id or False,
            'payment_term_id': company_partner.property_supplier_payment_term_id.id or False,
            'auto_generated': True,
